<!doctype html>
<html class="fixed sidebar-light sidebar-left-sm header-dark" lang="es">
	<head>

		<!-- Basic -->
		<meta charset="UTF-8">

		<title>Area de revendedores | Sistema Global.</title>
		<meta name="keywords" content="Sistema Global" />
		<meta name="description" content="Sistema Global">
		<meta name="author" content="Antony Culqui">

		<!-- Favicons -->
		<link href="https://i.imgur.com/ZjxPBUa.png" rel="icon">
  <link href="https://i.imgur.com/ZjxPBUa.png" rel="apple-touch-icon">
		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="#" class="logo">
						<img src="img/sistema-global-logo.png" width="180" height="44" alt="Porto Admin" />
					</a>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-bs-toggle="dropdown">
							...
							<div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
								<span class="name">Antony Alfredo Culqui Carranza</span>
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled mb-2">
								<li class="divider"></li>
								<li>
									<a role="menuitem" tabindex="-1" href="#"><i class="bx bx-user-circle"></i> Mi perfil</a>
								</li>
								<li>
									<a role="menuitem" tabindex="-1" href="#"><i class="bx bx-power-off"></i> Cerrar sesión</a>
								</li>
							</ul>
						</div>
					</div>
				        ...
				        <div class="nano-content">
				            <nav id="menu" class="nav-main" role="navigation">
				                ...
				                <ul class="nav nav-main">
									...
									<li>
				                        <a class="nav-link" href="#">
				                            <i class="bx bxs-graduation" aria-hidden="true"></i>
				                            <span>Escuela</span>
				                        </a>                        
				                    </li>
									<li>
												...
												<h2>
													...
													<strong>
														<select class="form-control" id="salesSelector">
															<option value="Porto Admin" selected>Miembros 1</option>
															<option value="Porto Drupal" >Miembros 2</option>
															<option value="Porto Wordpress" >Miembros 3</option>
														</select>
													</strong>
												</h2>
